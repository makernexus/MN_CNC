 ...
 * 
 * This version, panel1t, is a debug version for the encoders. It looks at the main encoder and
 * one little encoder and ignores the joysticks and the othert two encoders
 * 
 */
#include <Wire.h>
...
{ 
  ...
  */
  {E_MAIN_A,4,0x80,INPUT_PULLUP},
  {E_MAIN_B,4,0x40,INPUT_PULLUP},
  {E_SPIN_A,4,0x20,INPUT_PULLUP},
  {E_SPIN_B,4,0x10,INPUT_PULLUP}
...
{ {0,0,E_MAIN_A,E_MAIN_B,0,0xff},  //all 8 bits of byte 0
  {0,0,E_SPIN_A,E_SPIN_B,1,0x1f}   //low 5 bits of byte 1
  /*
  {0,0,E_FEED_A,E_FEED_B,2,0x1f},   //low 5 bits of byte 2
  {0,0,E_JOG_A, E_JOG_B ,3,0x1f},   //low 5 bits of byte 3
  */
};
